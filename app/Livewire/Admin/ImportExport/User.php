...
class User extends Component
{
    ...
    public $roles = [UserModel::ROLE_KARYAWAN];
    public $file = null;
    ...
    public function render()
    {
        ...
        if ($this->file) {
            ...
            $users = empty($this->roles) ?
                new \Illuminate\Support\Collection :
                UserModel::whereIn('role', $this->roles)->get();
        } else {
    ...
    {
        $this->validate([
            'roles.*' => ['string', 'in:karyawan,atasan_divisi,hrd'],
